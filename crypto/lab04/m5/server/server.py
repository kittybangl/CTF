...
class Message:
    ...
    def from_bytes(cls, stream) -> "Message":
        ...
        print("len(remaining_stream)", len(remaining_stream))
        print("additional_metadata_len", additional_metadata_len)
    ...
    def to_bytes(self) -> bytes:
        ...
        print("proto_maj_version", proto_maj_version)
        print("proto_min_version", proto_min_version)
        print("additional_metadata_len", additional_metadata_len)
        print("b:", b)
        return b
...
class MontoneServer(CommandServer):
    ...
    def handle_init(self, msg):
        ...
        print("ts", ts)
        print("message_metadata", message_metadata)
        print("content", content)
        print("msg", msg)
        print("msg", msg.to_bytes())
...
# b: b'MONTONE-PROTOCOL9\x05\x00\x00\xc1\x06\x00\x00\x85t\x18d\x01\x00\x00\x02W3AB9Kzcz3L5qpEb\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10\x10Thank you for using Montone messaging services\x02\x02'